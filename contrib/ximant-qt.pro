...
RESOURCES += src/qt/ximant.qrc src/qt/ximant_locale.qrc

TRANSLATIONS += src/qt/locale/ximant_bg.ts \
                src/qt/locale/ximant_de.ts \
                src/qt/locale/ximant_en.ts \
                src/qt/locale/ximant_es.ts \
                src/qt/locale/ximant_fi.ts \
                src/qt/locale/ximant_fr.ts \
                src/qt/locale/ximant_it.ts \
                src/qt/locale/ximant_ja.ts \
                src/qt/locale/ximant_pl.ts \
                src/qt/locale/ximant_pt.ts \
                src/qt/locale/ximant_ru.ts \
                src/qt/locale/ximant_sk.ts \
                src/qt/locale/ximant_sv.ts \
                src/qt/locale/ximant_vi.ts \
                src/qt/locale/ximant_zh_CN.ts \
                src/qt/locale/ximant_zh_TW.ts
