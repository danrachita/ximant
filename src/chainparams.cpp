...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000001d34a71e7d4cc2694f5cb9b29b7b0becb40627f75fc9f4f2320376ac61a"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1526383649, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 5000; //Params().MasternodeColleteralLimxDev()
        ...
        const char* pszTimestamp = "Ximant cryptocurrency";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1526383649;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20939722;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x000001d34a71e7d4cc2694f5cb9b29b7b0becb40627f75fc9f4f2320376ac61a"));
        assert(genesis.hashMerkleRoot == uint256("0xe1ed9270ca23e4e50633eed89db7f22bc5aafe05c18db14e0435e38467e9c242"));
        

        vSeeds.push_back(CDNSSeedData("s1.ximant.pro", "s1.ximant.pro"));
        vSeeds.push_back(CDNSSeedData("s2.ximant.pro", "s2.ximant.pro"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
        ...
        nStartMasternodePayments = 1526383649; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1526383650;
        genesis.nNonce = 26142124;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000e8d84a7badf42b4f48b4e8c58ff134e8d0352a5ddab660cd050ba3f26e0"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Ximant BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Ximant BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Ximant BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1526383650;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1526383651;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 2;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x66ccfc5ac093eeaee8e17c94ecd4eec539fa04223c80b6c875988fce9cf8e833"));
