/* src/config/ximant-config.h.  Generated from ximant-config.h.in by configure.  */
/* src/config/ximant-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://ximant.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ximant Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ximant Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ximant"
