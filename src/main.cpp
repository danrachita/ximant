...
#if defined(NDEBUG)
#error "Ximant cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Ximant Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 2300 ) {
	        nSubsidy = 1 * COIN;
	} else if( nHeight > 2300 && nHeight <= 6000 ) {
	        nSubsidy = 60 * COIN;
	} else if( nHeight > 6000 && nHeight <= 11000 ) {
	        nSubsidy = 120 * COIN;
	} else if( nHeight > 11000 && nHeight <= 22000 ) {
	        nSubsidy = 240 * COIN;
	} else {
		nSubsidy = 120 * COIN;
	}
