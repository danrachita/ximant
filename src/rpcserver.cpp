...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XNT features */
        {"ximant", "masternode", &masternode, true, true, false},
        {"ximant", "masternodelist", &masternodelist, true, true, false},
        {"ximant", "mnbudget", &mnbudget, true, true, false},
        {"ximant", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ximant", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ximant", "mnsync", &mnsync, true, true, false},
        {"ximant", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"ximant", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ximantd, or the -server option to ximant-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Ximant Alert\" admin@foo.com\n"),
...
{
    return "> ximant-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9040/\n";
}
